...
/mob/living/simple_animal/hostile/spawner/mining
	name = "monster den"
	desc = "A hole dug into the ground, harboring all kinds of monsters found within most caves or mining wastelands."
	icon_state = "hole"
	icon_living = "hole"
	health = 200
	maxHealth = 200
	...
	mob_type = /mob/living/simple_animal/hostile/wasteland/goldgrub
	atmos_requirements = list("min_oxy" = 0, "max_oxy" = 0, "min_tox" = 0, "max_tox" = 0, "min_co2" = 0, "max_co2" = 0, "min_n2" = 0, "max_n2" = 0)
	faction = list("mining")
...
/mob/living/simple_animal/hostile/spawner/mining/goliath
	...
	mob_type = /mob/living/simple_animal/hostile/wasteland/goliath

/mob/living/simple_animal/hostile/spawner/mining/hivelord
	name = "hivelord den"
	desc = "A den housing a nest of hivelords."
	mob_type = /mob/living/simple_animal/hostile/wasteland/hivelord

/mob/living/simple_animal/hostile/spawner/mining/basilisk
	name = "basilisk den"
	desc = "A den housing a nest of basilisks, bring a coat."
	mob_type = /mob/living/simple_animal/hostile/wasteland/basilisk

/mob/living/simple_animal/hostile/spawner/mining/wumborian
	name = "wumborian fugu den"
	desc = "A den housing a nest of wumborian fugus, how do they all even fit in there?"
	mob_type = /mob/living/simple_animal/hostile/wasteland/fugu