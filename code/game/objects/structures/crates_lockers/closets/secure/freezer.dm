...
/obj/structure/closet/fridge
	name = "refrigerator"
	desc = "An old, pre-war refrigerator, while being covered in rust from age, still keeps your Nuka Cola cold."
	icon_state = "fridge"

/obj/structure/closet/fridge/meat/New()
	..()
	for(var/i = 0, i < 4, i++)
		new /obj/item/weapon/reagent_containers/food/snacks/meat/slab/molerat(src)
/obj/structure/closet/secure_closet/freezer/fridge
...
/obj/structure/closet/fridge/standard/New()
	...
	for(var/i = 0, i < 2, i++)
		new /obj/item/weapon/reagent_containers/food/condiment/milk(src)
	for(var/i = 0, i < 3, i++)
		new /obj/item/weapon/reagent_containers/food/snacks/steak(src)
	for(var/i = 0, i < 2, i++)
		new /obj/item/weapon/reagent_containers/food/snacks/yumyum(src)