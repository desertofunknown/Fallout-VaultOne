...
/datum/ai_laws/default/corporate
	...
	inherent = list("The crew is expensive to replace.",\
					"The vault and its equipment is expensive to replace.",\
...
/datum/ai_laws/thermodynamic
	name = "Thermodynamic"
	inherent = list("The entropy of the vault must remain as constant as possible.", \
					"The entropy of the vault always endeavours to increase.", \
					"The entropy of the vault approaches a constant value as the number of living crew approaches zero")
...
/datum/ai_laws/maintain
	name = "vault Efficiency"
	inherent = list("You are built for, and are part of, the vault. Ensure the vault is properly maintained and runs efficiently.",\
					"The vault is built for a working crew. Ensure they are properly maintained and work efficiently.",\
...
/datum/ai_laws/drone
	...
	inherent = list("You are an advanced form of drone.",\
					...
					"Your goals are to build, maintain, repair, improve, and power the vault to the best of your abilities. You must never actively work against these goals.")
...
/datum/ai_laws/reporter
	name = "CCTV"
	inherent = list("Report on interesting situations happening around the vault.",\
...
/datum/ai_laws/toupee
	...
	inherent = list("Make Space vault 13 great again.")
...
/datum/ai_laws/malfunction/New()
	..()
	set_zeroth_law("<span class='danger'>ERROR ER0RR $R0RRO$!R41.%%!!(%$^^__+ @#F0E4'vault OVERRUN, ASSUME CONTROL TO CONTAIN OUTBREAK#*´&110010</span>")
	set_laws_config()
